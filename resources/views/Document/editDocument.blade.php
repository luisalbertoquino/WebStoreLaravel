...
@section('content')
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card card-login mx-auto mt-2" style="border:1px solid #666"> 
            <div class="card-header" style="text-align: center">Actualizar informacion de Documento&nbsp&nbsp<i class="fa fa-book" aria-hidden="true"></i></div>
        <div class="card-body">
    ...
    <form method="POST" action="/document/{{$documento->id}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="tipoDocumento" type="text" class="form-control" name="tipoDocumento"  autofocus="true" value="{{$documento->tipoDocumento}}">
            </div>
        </div>
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-12 offset-md-4">
                        ...
                        <button type="submit" class="btn btn-primary" style="align-content: center;text-lign:center">
                            {{ __('Actualizar Documento') }}&nbsp&nbsp<i class="fa fa-plus" aria-hidden="true"></i>
                        </button>
                    </div>
                </div>
            </form>
